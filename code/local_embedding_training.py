...
def run_word2vec(pd_map, docs, cates, folder):
    for cate in cates:
        ...
        print(input_f)
        print(output_f)
        # embed_proc = subprocess.Popen(["/Users/trinhgiang/PycharmProjects/taxogen/code/word2vec.c", "-threads", "20", "-train", input_f, "-output", output_f], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        # embed_proc.wait()
        cmd = './word2veec -threads 20 -train ' + input_f + ' -output ' + output_f
